...
const BLOG = {
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'tangly1024', // 作者
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  PROFILE_LINK:
    process.env.NEXT_PUBLIC_PROFILE_LINK || 'https://tangly1024.com', // 网站地址
  ...
  FONT: 'font- tracking-wider subpixel-antialiased', // 文章字体 ['font-sans', 'font-serif', 'font-mono'] @see https://www.tailwindcss.cn/docs/font-family
  FONT_AWESOME_PATH:
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_EMAIL || 'mail@tangly1024.com',
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_WEIBO || '',
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_TWITTER || '',
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_GITHUB || 'https://github.com/tangly1024',
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_TELEGRAM || '',
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_YOUTUBE || '',

  // 悬浮挂件
  WIDGET_PET: process.env.NEXT_PUBLIC_WIDGET_PET || false, // 是否显示宠物挂件
  WIDGET_PET_LINK:
    'https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  WIDGET_PET_SWITCH_THEME: process.env.NEXT_PUBLIC_PET_SWITCH_THEME || false, // 点击宠物挂件切换博客主题
  ...
  COMMENT_GISCUS_CATEGORY:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY || '', // 你的Github Discussions 內的 Category ( 設定完 giscus 即可看到 )
